...
class demo_FindAllContours : public IDemoCase
{
public:
	///@brief default ctor
	demo_FindAllContours()
		: m_threshold(127)
	{
		// nothing to do
	}
...
///////////////////////////////////////////////////////////////////////////////
void demo_FindAllContours::execute()
{
...
///////////////////////////////////////////////////////////////////////////////
void demo_FindAllContours::applyParameters(int, void* data)
{
	auto demo = static_cast<demo_FindAllContours*>(data);
	...
	cv::findContours(origImage, contours, cv::RETR_LIST, cv::CHAIN_APPROX_NONE);
	cv::Mat cvImage(origImage.size(), CV_8UC1, cv::Scalar(0.0, 0.0, 0.0));
	cv::drawContours(cvImage, contours, -1, cv::Scalar(255.0, 255.0, 255.0), 1);
	...
	ref_FindAllContours(&srcVXImage, &dstVXImage);
...
{
	return std::make_unique<demo_FindAllContours>();
}
